                                        ...
                                        if ($d==0) {
                                         ...
                                         <?php 
                                          foreach ($_COOKIE['item'] as $name1 => $value) {
                                              ...
                                              ?>
                                        <tr>
                                            <td><img src="../admin/<?php echo $value[2]; ?>" height="100" width="100" alt=""></td>
                                            <td><h6><?php echo $value[0]; ?></h6>
                                                <p>Size: <span>XL</span></p>
                                                <p>Color: <span>Black</span></p></td>
                                            <td><?php echo $value[1]; ?></td>
                                            <td><input readonly type="text" value="<?php echo $value[3]; ?>"></td>
                                            <td><input readonly type="text" value="<?php echo $value[4]; ?>"></td>
