                    ...
                    if ($img==$value11[2]) {
                     ...
                     if ($result) {
                         ...
                         if ($pro_qty < $qty ) {
                            ...
                            $total=$value[1]+$qty;
                            setcookie("item[$name1]",$img."__".$name."__".$price."__".$total,time()+1800);  
                          }
                        }
                    }
                }
					        	...
					        	<div class="grid-item2 mb30">
					        		<div class="row">
										<div class="arrival-overlay col-md-4">
											<img src="../admin/<?php echo $values['product_image']; ?>" height="257" alt="">
										</div>
										<div class="col-md-8">
											...
											<div class="list-content">
												...
												<div class="list-midrow">
													<ul>
													<li><span class="low-price"><?php echo $values['product_price']; ?>Rs-/</span></li>
													<li class="reviews"><a href="#">21 Rewiew(s)</a>  /  <a href="#">Add a Review</a></li>
                                                    </ul>
													<div>
                                                    <p>Available in Stock : <strong class="qty"> <?php echo $values['product_qty']; ?></strong> </p>
                                                    </div>
													<div class="clear"></div>
												</div>
												<p class="list-desc"><?php echo $values['description']; ?></p>
												<div class="list-downrow">
													<a href="#?id=<?php echo $values['id']; ?>" name="submit" class="medium-button button-red add-cart">Add to Cart</a>
													<ul>
