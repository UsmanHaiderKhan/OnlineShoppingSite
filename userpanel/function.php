...
{
    $element = "
     <div class=\"col-md-3 my-3 my-md-0 p-3\">
      <form action=\"AdvCart.php\" method=\"post\" enctype=\"multipart/form-data\" >
        <div class=\"card shadow bg-white\">
                    <div>
                   <img src=\"../admin/$productImage\" class=\"img-fluid card-img-top\" alt=\"$productname\" style=\"height:350px\">
                    </div>
                    <div class=\"card-body\">
                        ...
                        <h5 class=\"price\">$productPrice Rs-/</h5>
...
function cartProduct($productimg,$productname,$productprice)
{
    $cartElement="
     <form action=\"cartphp.php\" method=\"post\" enctype=\"multipart/form-data\">
